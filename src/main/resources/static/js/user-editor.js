...
function getUserHtml({userId, firstName, lastName, login}) {
    ...
    user.innerHTML = `
    <div class="row">
      <a class="col-md-9 d-flex" data-bs-toggle="collapse" href='#user${userId}' role="button" aria-expanded="false" aria-controls="collapseExample">
        <p class="user-info__name">${firstName} ${lastName}</p>
        <p class="user-info__email user__email__left">${login}</p>
      </a>
